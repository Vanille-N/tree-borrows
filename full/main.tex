...
\section{Future work} % FIXME: no longer future
...
\begin{paragraph}{Interpretation}
    ...
    noticeable when authors are actually careful about UB: in the popular crates that contain
    UB under SB and have actively tried to fix it but failed (\texttt{tokio}, \texttt{pyo3},
    \texttt{rkyv}, \texttt{eyre}, \texttt{ndarray}, \texttt{arrayvec}, \texttt{slotmap},
    \texttt{nalgebra}, \texttt{json}), all of them were found to be free of UB under TB.
\end{paragraph}
...
\begin{paragraph}{UB Shadowing}
    ...
    use that memory in nontrivial ways, which make aliasing errors more likely.
...
% FIXME: show an invariant, explain how we would use it
% FIXME: proven: disjointness
% FIXME: talk about difficulties encountered
% FIXME: Unique experiments
