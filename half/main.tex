...
The semantics require that on every access, every tag of the allocation be
updated. On allocations with many reborrows this can easily lead to a naive
implementation of Tree Borrows being slower than Stacked Borrows by an arbitrarily
...
% FIXME: also time to run tests
% FIXME: also time to run the stdlib
